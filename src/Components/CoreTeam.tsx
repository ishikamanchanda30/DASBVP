  ...
  const teamMembers = [
    {
      name: "VANSH GUPTA",
      position: "President",
      desc: "Lorem ipsum dolor sit amet consectetur. Nec augue amet in a non scelerisque at. Nunc ut nibh aliquam justo. Nibh entum ornare",
      image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&auto=format&fit=crop&w=687&q=80",
    },
    {
      name: "JOHN DOE",
      position: "Vice President",
      desc: "Another description text would go here following the same style as the first one.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=687&q=80",
    },
    {
      name: "JANE SMITH",
      position: "Secretary",
      desc: "Additional team member description in the same format and style as others.",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
    },
  ];

  return <Carousel slides={teamMembers} />;
};
