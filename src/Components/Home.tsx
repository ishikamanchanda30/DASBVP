...
function Home() {
    ...
    return (
        <div className="w-screen h-screen bg-[#0D0D0D] text-white font-kumbh relative overflow-hidden">
            ...
            <div className="absolute top-20 left-5 max-w-sm text-lg md:text-m text-left leading-5">
                Welcome to the art society of BVCOE. We shoot, sketch, design, and create — one frame, one pixel, one idea at a time.
            </div>

            <div className="absolute bottom-20 right-5 md:right-10 max-w-sm text-lg md:text-m text-right leading-5">
